  ...
  return (
    ...
    >
      <div className="relative h-4 w-4">
        <div
          className={cn('absolute top-0 delay-75 duration-1000 ease-in', {
            'rotate-360 scale-0 delay-0': theme === 'dark',
          })}
        >
          <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" className="h-6 w-6">
            <path
